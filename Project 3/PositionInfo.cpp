...
PositionInfo::PositionInfo() {
    ...
    normalTransformLoc = 0;
    modelingTransform = vmath::scale(1.0f);
    normalTransform = vmath::mat3(vmath::vec3(1.0f, 0.0f, 0.0f),
...
PositionInfo::PositionInfo(GLuint vao, GLuint bao, int nbrPoints,
    ...
    GLuint normalTransformLoc, vmath::mat3 normalTransformation) {
    this->vao = vao;
    this->bao = bao;
    this->nbrPoints = nbrPoints;
    this->modelingTransformLoc = modelingTransformLoc;
    ...
    this->color = color;
    this->normalTransformLoc = normalTransformLoc;
    this->normalTransform = normalTransformation;
}
...
void PositionInfo::draw() {
    ...
    glUniformMatrix4fv(modelingTransformLoc, 1, GL_FALSE,
        modelingTransform);
    glUniformMatrix3fv(normalTransformLoc, 1, GL_FALSE, normalTransform);
