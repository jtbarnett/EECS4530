...
public:
    ...
    PositionInfo(GLuint vao, GLuint bao, int nbrPoints,
        ...
        vmath::vec4 color, GLuint normalTransformLoc = 0,
        vmath::mat3 normalTransform = vmath::mat3(vmath::vec3(1.0f, 0.0f, 0.0f), vmath::vec3(0.0f, 1.0f, 0.0f), vmath::vec3(0.0f, 0.0f, 1.0f)));
    ...
    void setNormalTransform(vmath::mat3 normalTransform) {
        this->normalTransform = normalTransform;
    }
    void setNormalTransformLoc(GLuint loc) { normalTransformLoc = loc; }
};
